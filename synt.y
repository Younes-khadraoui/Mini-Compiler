...
HEADER : TYPE mc_routine IDF po PARAMETRE pf {rechercher ($3,"IDF","Identifier",0 , 0,ts);modifyType($3,$1,ts); rechercher ($2,"Mot cle ","",0, 1,ts);  rechercher ($4,"Separateur",0,0, 2,ts); rechercher ($6,"Separateur",0,0, 2,ts);}  
;
